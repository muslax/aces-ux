  ...
  return (
    <>
      ...
      <Stack spacing={10}>
        ...
        <Frame rounded title="Alamat Tes Mandiri" contrast={3} mt={10}>
          <Text size="sm" mb={20}>
      ...
      <SectionTitle size={15} mt={30} title="Daftar Peserta Tes Mandiri" />
      <Text mb={20}>Sesuai hasil screening Pendaftaran</Text>
    </>
  );
}
